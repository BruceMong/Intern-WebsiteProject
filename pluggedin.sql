...
INSERT INTO `entreprise` (`id_entreprise`, `nom`, `secteur_activite`, `nombre_stagiaire_cesi`, `confiance_pilote`, `evaluation_entreprise`, `image`, `localite`, `mail`) VALUES
(1, 'Saint-Gobin', 'Materiaux', 3, 4, 4, 'https://forcomm.fr/wp-content/uploads/2020/05/communication-unifiee-schema-500x500.jpg', 'Marseille', 'gobin@gmail.com'),
(2, 'Atos', 'Informatique', 1, 5, 4, 'https://forcomm.fr/wp-content/uploads/2020/05/communication-unifiee-schema-500x500.jpg', 'Paris', 'atos@gmail.com'),
(3, 'Mediamoov', 'Informatique', 4, 2, 4, 'https://ipfs.koreus.com/ipfs/QmP7sL9Z8i7X1JQqbTevZPfpnXJntKdGrPXceNBDzDhrNv', 'Strasbourg', 'strasbourg@gmail.com');
