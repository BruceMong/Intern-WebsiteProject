...
<div class=bloc_page>
    <div class="detail_container">
        ...
        <div class="detail_presentation">
            ...
            <p>Promotion : <?php $promoUtil = $modelPromotion->getPromotion($utilisateur->id_promotion());
                            echo $promoUtil->libelle();   ?></p>
            <p>Centre de formation : <?= $utilisateur->centre() ?> </p>
            <p>Role : <?php $profilUtil = $modelProfil->getProfil($utilisateur->id_profil());
                        echo $profilUtil->libelle()  ?> </p>
            ...
            <form action="detailUtilisateur" method="post">
                ...
                <table style="width: 100%;">
                    ...
                    <tbody>
                        ...
                        <td>
                            <label>
                                <input type="checkbox" name="authentifier" value=1 <?php
                    ...
                    <tbody>
                        ...
                        <td>
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="rechercher_entreprise" value=1 <?php
                                ...
                                <label>
                                    <input type="checkbox" name="creer_entreprise" value=1 <?php
                                ...
                                <br>
                                <label>
                                    <input type="checkbox" name="supprimer_entreprise" value=1 <?php
