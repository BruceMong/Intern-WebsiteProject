...
<section id="password" class="container">
    ...
    <form action="password" method="post">
        ...
        <p><label for="pass">Mot de passe actuel :</label>
            <input type="password" name="pass" id="pass" class="form-control" value="<?php if (isset($pass)) echo $pass; ?>" />
        </p>
        <br />
        <p><label for="newpass">Nouveau mot de passe :</label>
            <input type="password" name="newpass" id="newpass" class="form-control" value="<?php if (isset($newpass)) echo $newpass; ?>" />
        </p>
        <br />
